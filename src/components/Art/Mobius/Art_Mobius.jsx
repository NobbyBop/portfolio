    ...
    <div className="sketchOuterContainer">
      ...
      <div className="sketchTitle">
        ...
        <p>
          ...
          posters around their neighborhood, which links to the start of the
          game. This project invovled creating branding and marketing for our
          fictitious band MOBIUS LINE, as well as crafting a narrative. On this
          page I have included some of the graphic design work I did for the
          project, as well as some of our band photos, taken by Andrew
          Yurovchak. I hope you'll take a little time to explore the game{" "}
